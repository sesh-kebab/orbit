...
const DEMO_ACTIVITY: ActivityEntry[] = [
    {
        ...
        location: "~/code/lattice-web/docs/q3-headcount.md",
    ...
    },
    {
        ...
        status: "delivered",
        openedAt: EPOCH - 8_000_000,
    },
    {
        id: "a4",
        at: EPOCH - 86_400_000 * 2,
        day: "2025-06-10",
        kind: "artifact_written",
        description: "Code review of the payments refactor",
        location: "~/code/lattice-web/docs/payments-review.md",
        request: "review the payments refactor branch",
        status: "delivered",
    },
];
...
export function baseState(patch: Partial<OrbitState> = {}): OrbitState {
    const state: OrbitState = {
        ...
        board: { at: EPOCH, threads: [], artifacts: [], calls: [], blindSpots: [] },
